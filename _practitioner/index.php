                ...
                <section class="content container-fluid">
                    ...
                    <div class="box" style="top: 15px;">
                        <div class="box-header">
                            <h3 class="box-title">Available Patient in E-Triage</h3>
                        ...
                        <div class="box-body no-padding">
                            <div class="box-body">
                                ...
                                <?php
                                $sql = "SELECT * FROM registration where userlive=1";
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <span class="info-box-number">
                                                                    <div id="info-box-number">85 °C / 185 °F<br></div>
                                                                </span>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <span class="info-box-number">
                                                                <div id="heartrate">Please Turn On Device</div>
                                                            </span>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <span class="info-box-number">
                                                                <div id="oxygenlevel">Please Turn On Device</div>
                                                            </span>
                                    ...
                                    ?>
                                    <h4 class="box-title">No Patient Currently Available in E-Triage</h4>
                                    <?php
                                }
                                ?>
                                            ...
                                            <div class="box-body">
                                                ...
                                                <script>
                                                    ...
                                                    if (document.cookie.indexOf('mgVideoChatSimple') == -1) {
                                                        ...
                                                        var cookie = "mgVideoChatSimple=practitioner;path=/";
