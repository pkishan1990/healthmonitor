                        ...
                        <div class="box-body no-padding">
                            <table class="table table-striped">
                                <tbody><tr>
                                        ...
                                        <th style="width: 10px">E Triage Score</th>
                                        <th style="width: 10px">More Details</th>
                                    </tr>
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            <tr>
                                                ...
                                                <td><a href=userdetails.php?id=<?php echo $row['id'] ?> target="_blank">Click Here</a></span></td>
                                            </tr>
