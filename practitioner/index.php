                ...
                <section class="content container-fluid">
                    ...
                    <div class="box" style="top: 15px;">
                        <div class="box-header">
                            <h3 class="box-title">Following Cases Requires Attention</h3>
                                ...
                                <div class="box" style="top: 15px;">
                                    ...
                                    <div class="box-body no-padding">
                                        ...
                                        <script>
                                            ...
                                            {
                                                $('#newcase').load('../emergency/newcases.php?new=1&practitioner=1');
                                            }
                                        </script>
                                        <div id="newcase"></div>
                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="box-body">
                                                <script>
                                                    ...
                                                    function refreshData()
                                                    {
                                                        $('#oldcase').load('../emergency/newcases.php?old=1&practitioner=1');
                                                    }
                                                </script>
                                                <div id="oldcase"></div> 
                                            </div>                                            
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box collapsed-box" style="top: 15px;">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Non Urgent Cases</h3>
                                        ...
                                        <div class="col-md-12">
                                            <div class="box-body">
                                                <script>
                                                    ...
                                                    function refreshData()
                                                    {
                                                        $('#nonurgentcases').load('../emergency/newcases.php?nonurgent=1&practitioner=1');
                                                    }
                                                </script>
                                                <div id="nonurgentcases"></div> 
                                            </div>                                            
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="box-body">
                                                ...
                                                <script>
                                                    ...
                                                    if (document.cookie.indexOf('mgVideoChatSimple') == -1) {
                                                        ...
                                                        var cookie = "mgVideoChatSimple=General Practitioner;path=/";
